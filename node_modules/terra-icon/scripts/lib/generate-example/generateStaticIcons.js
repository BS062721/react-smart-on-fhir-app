...
var outputfile = _fs2.default.createWriteStream('../../packages/terra-site/src/examples/icon/components/IconStatic.jsx', { flags: 'w' }); /* eslint-disable */


var generateIconAll = function generateIconAll(iconObjs) {
  return new Promise(function (resolve) {

    var staticIcons = iconObjs.filter(function (iconObj) {
      return !iconObj.themeable;
    });
    ...
    staticIcons.forEach(function (iconObj) {
