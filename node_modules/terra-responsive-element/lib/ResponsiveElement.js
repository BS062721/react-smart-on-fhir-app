...
var _breakpoints = require('./breakpoints.scss');
...
var ResponsiveElement = function (_React$Component) {
  ...
  _createClass(ResponsiveElement, [{
    ...
    value: function handleResize(width) {
      var element = void 0;
      var tiny = _breakpoints2.default.tiny,
          small = _breakpoints2.default.small,
          medium = _breakpoints2.default.medium,
          large = _breakpoints2.default.large,
          huge = _breakpoints2.default.huge;
